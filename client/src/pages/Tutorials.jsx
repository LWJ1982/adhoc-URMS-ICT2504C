    ...
    return (
        <Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                ...
                <IconButton color="primary" onClick={onClickSearch}><Search />
                </IconButton><IconButton color="primary" onClick={onClickClear}><Clear />
            ...
            <Grid container spacing={2}>
                {
                    tutorialList.map((tutorial, i) => {
                        return (
                            //Individual Card
                            //Container Size
                            //Add icon-material below </Typography><Box> tag
                            <Grid item sm={12} md={6} lg={4} key={tutorial.id}>
                                <Card>
                                    <CardContent>
